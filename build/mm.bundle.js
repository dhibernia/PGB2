...
angular.module('mm.core.contentlinks')
.controller('mmContentLinksChooseSiteCtrl', ["$scope", "$stateParams", "$mmSitesManager", "$mmUtil", "$ionicHistory", "$state", "$mmContentLinksDelegate", function($scope, $stateParams, $mmSitesManager, $mmUtil, $ionicHistory, $state,
...
angular.module('mm.core.contentlinks')
.factory('$mmContentLinksHelper', ["$log", "$ionicHistory", "$state", "$mmSite", "$mmSitesManager", "$mmContentLinksDelegate", "$q", "$mmUtil", "$translate", function($log, $ionicHistory, $state, $mmSite, $mmSitesManager, $mmContentLinksDelegate, $q,
            $mmUtil, $translate) {
...
angular.module('mm.addons.mod_glossary')
.factory('$mmaModGlossaryCourseContentHandler', ["$mmCourse", "$mmSite", "$state", function($mmCourse, $mmSite, $state) {
    var self = {};
        self.isEnabled = function() {
...
angular.module('mm.addons.mod_glossary')
.factory('$mmaModGlossary', ["$mmSite", "$q", function($mmSite, $q) {
    var self = {};
...
.constant('mmCoreConfigConstants', {
    ...
    "sireurl": "http://myhelms.dev.hiberniacollege.com/moodle",
	"gcmpn": "694767596569"
}
);